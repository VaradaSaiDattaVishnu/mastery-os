    ...
    modules: [
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'ai-ml-anomaly-algos', title: 'Choosing a detector: IF vs kNN, LOF & k-means', coreIdea: 'Every order is a dot; normal ones cluster, weird ones sit alone — four ways to spot the loners, and why Isolation Forest fits order fraud.', project: 'Order — detector selection', concepts: ['anomaly detection', 'Isolation Forest', 'kNN', 'LOF', 'k-means'] },
